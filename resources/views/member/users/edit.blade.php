    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        <form method="post" action="{{ route('member.users.update', ['user' => $data->id]) }}"
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" value="{{ old('name', $data->name) }}"
                                    type="text" class="mt-1 block w-full" required />
                            </div>
                            <div>
                                <x-input-label for="email" value="Email" />
                                <x-text-input id="email" name="email" value="{{ old('email', $data->email) }}"
                            ...
                            <div>
                                ...
                                <x-text-input id="new_password_confirmation" name="new_password_confirmation"
                                    value="" type="password" class="mt-1 block w-full" />
                            </div>
